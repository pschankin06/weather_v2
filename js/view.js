...
export function addToFavorites(cityName) {
  const isInList = searchInList(cityName);
...
//     const likeButton = UI_ELEMENTS.CURRENT_WEATHER.LIKE_BUTTON.querySelector('svg');
//     likeButton.classList.toggle('like-city--added');
//     likeButton.querySelector('path').classList.toggle('like-city--added');
// }